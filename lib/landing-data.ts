...
export const PLANS: Plan[] = [
  {
    ...
    tagline: "입문 크리에이터",
    priceMonthly: 30,
    priceYearly: 30, // Assuming same for now as Price_model.md only specified $30
    highlights: ["330 크레딧/월", "HD/FHD 렌더링", "보관 7일", "1개 동시 Export"],
    ctaLabel: "Starter 시작",
  ...
  },
  {
    ...
    priceMonthly: 60,
    priceYearly: 60,
    highlights: ["660 크레딧/월", "HD/FHD/4K 지원", "보관 30일", "2개 동시 Export"],
    ctaLabel: "Pro 시작",
  ...
  },
  {
    ...
    priceMonthly: 120,
    priceYearly: 120,
    highlights: ["1320 크레딧/월", "우선 순위 큐", "보관 60일", "3개 동시 Export"],
    ctaLabel: "Plus 시작",
  ...
  },
  {
    ...
    priceMonthly: 180,
    priceYearly: 180,
    highlights: ["1980 크레딧/월", "최고 우선 순위", "보관 90일", "5개 동시 Export"],
    ctaLabel: "Max 시작",
