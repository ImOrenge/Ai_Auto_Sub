...
export default async function BillingPage() {
    ...
    const usagePercentage = Math.min(100, (entitlements.stt.used / entitlements.stt.total) * 100);
                    ...
                    <div className="mt-6">
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">
                                {entitlements.stt.used} / {entitlements.stt.total} mins
                            </span>
                        </div>
                        <div className="mt-2 h-2 overflow-hidden rounded-full bg-secondary">
                            <div
                                className={cn(
                                    ...
                                    entitlements.stt.isOverLimit ? "bg-red-500" : "bg-primary"
                                )}
                                style={{ width: `${usagePercentage}%` }}
                            />
                        </div>
                        {entitlements.stt.isOverLimit && (
                    ...
                    <article className="rounded-2xl border bg-card/80 p-5 shadow-sm">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-semibold">{entitlements.stt.remaining}m</p>
                            </div>
                        </div>
                    </article>
                    <article className="rounded-2xl border bg-card/80 p-5 shadow-sm">
